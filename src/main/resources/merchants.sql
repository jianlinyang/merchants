...
(
    ...
    'logo_url'             varchar(256) collate utf8_bin not null collate '商户logo',
    'business_license_url' varchar(256) collate utf8_bin not null collate '商户营业执照',
  ...
  AUTO_INCREMENT = 17 DEFAULT CHARACTER SET = utf8;
